function resting_potential_data(recdate,varargin)
if nargin>1
    cellnum=varargin{1};
else
    cellnum='A';
...
for k=1:trials_control+trials_propofol
    data_name=['resting_potential_' recdate '_' cellnum num2str(k)];
    resting_potential_data_individual(data_name);
end

function resting_potential_data_individual(my_file,varargin)
% example: resting_potential_data('resting_potential_Jul_20_11_A9') will pull the text file of
