...
for k=1:numel(dates)
    eval(['load hp_integral_' dates{k} '_' cellnum{k} '.mat;'])
...
title(['Effects of ' num2str(conc_propofol) ' \muM Propofol on AHP Integral at '...
    num2str(avg_rate_comparison) ' \pm 0.25 Hz'],'fontsize',16)
ylabel('AHP Integral [mV ms]','fontsize',12)
hold on
