function count_rate(recdate,varargin)
...
figure;eval(['plot(currents,control_all_' recdate '_' cellnum ',currents,control_pf_all_'...
    recdate '_' cellnum '_countrate(1)*currents+control_pf_all_' recdate '_' cellnum...
    '_countrate(2),currents,propofol_all_' recdate '_' cellnum ',currents,propofol_pf_all_'...
    recdate '_' cellnum '_countrate(1)*currents+propofol_pf_all_' recdate '_' cellnum '_countrate(2))'])
...
figure;eval(['plot(currents,control_init_' recdate '_' cellnum ',currents,control_pf_init_'...
    recdate '_' cellnum '_countrate(1)*currents+control_pf_init_' recdate '_' cellnum...
    '_countrate(2),currents,propofol_init_' recdate '_' cellnum ',currents,propofol_pf_init_'...
    recdate '_' cellnum '_countrate(1)*currents+propofol_pf_init_' recdate '_' cellnum '_countrate(2))'])
...
figure;eval(['plot(currents,control_accom_' recdate '_' cellnum ',currents,control_pf_accom_'...
    recdate '_' cellnum '_countrate(1)*currents+control_pf_accom_' recdate '_' cellnum...
    '_countrate(2),currents,propofol_accom_' recdate '_' cellnum ',currents,propofol_pf_accom_'...
    recdate '_' cellnum '_countrate(1)*currents+propofol_pf_accom_' recdate '_' cellnum '_countrate(2))'])
